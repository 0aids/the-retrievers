...
void ADXL375_Setup() {
 ...
 ESP_ERROR_CHECK(i2c_master_bus_add_device(BusHandle, &ADXL375_Config, &ADXL375_Handle));
    ...
    ESP_ERROR_CHECK(i2c_master_transmit(ADXL375_Handle, ADXL375_PowerTransmit, 2, -1));

    ESP_ERROR_CHECK(i2c_master_transmit(ADXL375_Handle, ADXL375_FIFOTransmit, 2, -1));
