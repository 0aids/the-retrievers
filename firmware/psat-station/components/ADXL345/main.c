...
uint8_t ADXL345_PowerTransmit[2] = {ADXL345_POWER_TRANSMIT_ADDRESS,
                                    ADXL345_POWER_TRANSMIT_DATA};

uint8_t ADXL345_FIFOTransmit[2] = {ADXL345_FIFO_TRANSMIT_ADDRESS,
                                   ADXL345_FIFO_TRANSMIT_DATA};
...
void ADXL345_getData(uint16_t* Xacc, uint16_t* Yacc, uint16_t* Zacc)
{
    ...
    ESP_ERROR_CHECK_WITHOUT_ABORT(i2c_master_transmit_receive(
        ADXL345_Handle, &ADXL345_DataRegister, 1, i2cout, 6, 100));
    printf("Data Rcieved\n");
