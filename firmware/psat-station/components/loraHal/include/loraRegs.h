...
#define loraBit_opMode_accessSharedRegMsk_d                          \
    (0x1 << loraBit_opMode_accessSharedRegPos_d)
#define loraBit_opMode_longRangeModeMsk_d                            \
    (0x1 << loraBit_opMode_longRangeModePos_d)
...
#define loraBit_opMode_accessSharedReg_false_d                       \
    (0x0 << loraBit_opMode_accessSharedRegPos_d)
#define loraBit_opMode_accessSharedReg_true_d                        \
    (0x1 << loraBit_opMode_accessSharedRegPos_d)

#define loraBit_opMode_longRangeMode_fskOok_d                        \
    (0x0 << loraBit_opMode_longRangeModePos_d)
#define loraBit_opMode_longRangeMode_lora_d                          \
    (0x1 << loraBit_opMode_longRangeModePos_d)
...
/* Bit Masks */
#define loraBit_paCfg_paSelectMsk_d                                  \
    (0x1 << loraBit_paCfg_paSelectPos_d)
#define loraBit_paCfg_maxPowerMsk_d                                  \
    (0x7 << loraBit_paCfg_maxPowerPos_d)
#define loraBit_paCfg_outputPowerMsk_d                               \
    (0xF << loraBit_paCfg_outputPowerPos_d)

/* Options */
#define loraBit_paCfg_paSelect_rfo_d                                 \
    (0x0 << loraBit_paCfg_paSelectPos_d) /* Output on RFO pin */
#define loraBit_paCfg_paSelect_boost_d                               \
    (0x1 << loraBit_paCfg_paSelectPos_d) /* Output on PA_BOOST pin */
...
/* Options - Gain */
#define loraBit_lna_gain_g1_d                                        \
    (0x1 << loraBit_lna_gainPos_d) /* Max Gain */
...
#define loraBit_lna_gain_g6_d                                        \
    (0x6 << loraBit_lna_gainPos_d) /* Min Gain */
...
#define loraBit_irqFlags_rxTimeoutMsk_d                              \
    (0x1 << loraBit_irqFlags_rxTimeoutPos_d)
#define loraBit_irqFlags_rxDoneMsk_d                                 \
    (0x1 << loraBit_irqFlags_rxDonePos_d)
#define loraBit_irqFlags_crcErrMsk_d                                 \
    (0x1 << loraBit_irqFlags_crcErrPos_d)
#define loraBit_irqFlags_validHeadMsk_d                              \
    (0x1 << loraBit_irqFlags_validHeadPos_d)
#define loraBit_irqFlags_txDoneMsk_d                                 \
    (0x1 << loraBit_irqFlags_txDonePos_d)
#define loraBit_irqFlags_cadDoneMsk_d                                \
    (0x1 << loraBit_irqFlags_cadDonePos_d)
#define loraBit_irqFlags_fhssChangeMsk_d                             \
    (0x1 << loraBit_irqFlags_fhssChangePos_d)
#define loraBit_irqFlags_cadDetectMsk_d                              \
    (0x1 << loraBit_irqFlags_cadDetectPos_d)
...
#define loraBit_mdmCfg1_implicitHeadMsk_d                            \
    (0x1 << loraBit_mdmCfg1_implicitHeadPos_d)
...
/* Options - Header Mode */
#define loraBit_mdmCfg1_implicitHead_off_d                           \
    (0x0 << loraBit_mdmCfg1_implicitHeadPos_d) /* Explicit */
#define loraBit_mdmCfg1_implicitHead_on_d                            \
    (0x1 << loraBit_mdmCfg1_implicitHeadPos_d) /* Implicit */
...
#define loraBit_mdmCfg2_txContMsk_d                                  \
    (0x1 << loraBit_mdmCfg2_txContPos_d)
#define loraBit_mdmCfg2_rxCrcMsk_d (0x1 << loraBit_mdmCfg2_rxCrcPos_d)
#define loraBit_mdmCfg2_symbTimeMsbMsk_d                             \
    (0x3 << loraBit_mdmCfg2_symbTimeMsbPos_d)
...
/* Options - CRC */
#define loraBit_mdmCfg2_rxCrc_off_d                                  \
    (0x0 << loraBit_mdmCfg2_rxCrcPos_d)
#define loraBit_mdmCfg2_rxCrc_on_d (0x1 << loraBit_mdmCfg2_rxCrcPos_d)

#define loraBit_mdmCfg2_txCont_off_d                                 \
    (0x0 << loraBit_mdmCfg2_txContPos_d)
#define loraBit_mdmCfg2_txCont_on_d                                  \
    (0x1 << loraBit_mdmCfg2_txContPos_d)
...
/* Bit Masks */
#define loraBit_mdmCfg3_lowDataOptMsk_d                              \
    (0x1 << loraBit_mdmCfg3_lowDataOptPos_d)
#define loraBit_mdmCfg3_agcAutoMsk_d                                 \
    (0x1 << loraBit_mdmCfg3_agcAutoPos_d)

/* Options */
#define loraBit_mdmCfg3_lowDataOpt_off_d                             \
    (0x0 << loraBit_mdmCfg3_lowDataOptPos_d)
#define loraBit_mdmCfg3_lowDataOpt_on_d                              \
    (0x1 << loraBit_mdmCfg3_lowDataOptPos_d)

#define loraBit_mdmCfg3_agcAuto_off_d                                \
    (0x0 << loraBit_mdmCfg3_agcAutoPos_d)
#define loraBit_mdmCfg3_agcAuto_on_d                                 \
    (0x1 << loraBit_mdmCfg3_agcAutoPos_d)
...
#define loraBit_paRamp_modulationShapingPos_d                        \
    (5) /* FSK only, but mask exists */
#define loraBit_paRamp_paRampPos_d (0)

#define loraBit_paRamp_paRampMsk_d (0xF << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_3_4ms_d                                \
    (0x0 << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_2ms_d                                  \
    (0x1 << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_1ms_d                                  \
    (0x2 << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_500us_d                                \
    (0x3 << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_250us_d                                \
    (0x4 << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_125us_d                                \
    (0x5 << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_100us_d                                \
    (0x6 << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_62us_d                                 \
    (0x7 << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_50us_d                                 \
    (0x8 << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_40us_d                                 \
    (0x9 << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_31us_d                                 \
    (0xA << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_25us_d                                 \
    (0xB << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_20us_d                                 \
    (0xC << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_15us_d                                 \
    (0xD << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_12us_d                                 \
    (0xE << loraBit_paRamp_paRampPos_d)
#define loraBit_paRamp_paRamp_10us_d                                 \
    (0xF << loraBit_paRamp_paRampPos_d)
...
#define loraReg_addrFifoAddrPtr_d                                    \
    0x0D /* SPI Interface Address Pointer */
#define loraReg_addrFifoTxBaseAddr_d                                 \
    0x0E /* Write base address in FIFO */
#define loraReg_addrFifoRxBaseAddr_d                                 \
    0x0F /* Read base address in FIFO */
#define loraReg_addrFifoRxCurAddr_d                                  \
    0x10 /* Start address of last packet received */
...
#define loraBit_mdmStat_modemClearMsk_d                              \
    (0x1 << loraBit_mdmStat_modemClearPos_d)
#define loraBit_mdmStat_headInfoValidMsk_d                           \
    (0x1 << loraBit_mdmStat_headInfoValidPos_d)
#define loraBit_mdmStat_rxOnGoingMsk_d                               \
    (0x1 << loraBit_mdmStat_rxOnGoingPos_d)
#define loraBit_mdmStat_sigSyncMsk_d                                 \
    (0x1 << loraBit_mdmStat_sigSyncPos_d)
#define loraBit_mdmStat_sigDetectMsk_d                               \
    (0x1 << loraBit_mdmStat_sigDetectPos_d)
...
#define loraBit_hopChan_pllTimeoutMsk_d                              \
    (0x1 << loraBit_hopChan_pllTimeoutPos_d)
#define loraBit_hopChan_crcOnPayloadMsk_d                            \
    (0x1 << loraBit_hopChan_crcOnPayloadPos_d)
#define loraBit_hopChan_fhssChanMsk_d                                \
    (0x3F << loraBit_hopChan_fhssChanPos_d)
...
#define loraReg_addrFeiMsb_d                                         \
    0x28 /* Bits 19-16? Check datasheet specific rev, usually 20-bit signed */
