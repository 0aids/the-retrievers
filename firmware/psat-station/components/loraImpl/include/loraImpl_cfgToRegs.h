...
/* --- 3. Header Mode (RegModemConfig1) --- */
    ...
    #define loraHalCfg_mdmCfg1_implicitHead_d   loraBit_mdmCfg1_implicitHead_on_d
#else
    #define loraHalCfg_mdmCfg1_implicitHead_d   loraBit_mdmCfg1_implicitHead_off_d
#endif
...
#if ((loraCfg_bandwidth_d == 0) && (loraCfg_spreadingFactor_d >= 11)) || \
    ((loraCfg_bandwidth_d == 1) && (loraCfg_spreadingFactor_d == 12))
    #define loraHalCfg_mdmCfg3_lowDataOpt_d     loraBit_mdmCfg3_lowDataOpt_on_d
#else
    #define loraHalCfg_mdmCfg3_lowDataOpt_d     loraBit_mdmCfg3_lowDataOpt_off_d
#endif
...
#define loraHalCfg_frf_val_d                    ((uint32_t)((uint64_t)loraCfg_frequency_d * 524288UL / LORA_XOSC_FREQ_HZ))
...
/* Pout = 2 + OutputPower (on PA_BOOST) */
    ...
    #define loraHalCfg_paCfg_outputPower_d      ((loraCfg_txOutputPower_d - 2) << loraBit_paCfg_outputPowerPos_d)
#endif

/* --- 10. Helper Values (Direct Mappings) --- */
#define loraHalCfg_preamble_val_d               ((uint16_t)loraCfg_preambleLength_d)
#define loraHalCfg_mdmCfg2_symbTimeoutMsb_d     ((uint8_t)((loraCfg_symbolTimeout_d >> 8) & 0x03))
#define loraHalCfg_symbTimeout_lsb_d            ((uint8_t)(loraCfg_symbolTimeout_d & 0xFF))
